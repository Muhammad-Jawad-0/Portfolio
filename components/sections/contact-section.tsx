...
//                       onChange={handleChange}
//                       className={`transition-all duration-200 resize-none ${errors.message ? "border-red-500 focus:border-red-500" : "focus:border-primary"}`}
//                     />
//                     <AnimatePresence>
//                       {errors.message && (
//                         <motion.p
...
//                   <p className="text-muted-foreground">
//                     Based in San Francisco, CA. Open to remote work and collaboration.
//                   </p>
//                 </div>

//                 <div>
//                   <h4 className="text-lg font-semibold text-foreground mb-2">Availability</h4>
//                   <p className="text-muted-foreground">Currently available for new projects and collaborations.</p>
//                 </div>
//               </motion.div>
//             </div>
//           </motion.div>
